...
public class NinjaController {
    ...
    public ResponseEntity<String> criarNovoNinja(
    ...
    @GetMapping("/todos/{id}")
    @Operation(summary = "Listar um Ninja por Id", description = "Rota que lista um Ninja específico a partir do ID próprio")
    @ApiResponses(value = {
    ...
    public ResponseEntity<?> listarNinjasPorId(
            @Parameter(description = "ID do ninja a ser listado")
    ...
    @Operation(summary = "Alterar um Ninja por Id", description = "Rota que altera um Ninja específico a partir do ID próprio")
    @ApiResponses(value = {
            @ApiResponse(responseCode = "200", description = "Ninja alterado com sucesso"),
            @ApiResponse(responseCode = "404", description = "Não foi possível listar o ninja :(")
    })
    public ResponseEntity<String> alterarNinjaID(
            @Parameter(description = "ID do ninja a ser alterado")
            @PathVariable Long id,
            @Parameter(description = "Dados atualizados do ninja")
            @RequestBody NinjaDTO ninjaRequisicao) {
    ...
    @Operation(summary = "Deletar um Ninja por Id", description = "Rota que deleta um Ninja específico a partir do ID próprio")
    @ApiResponses(value = {
